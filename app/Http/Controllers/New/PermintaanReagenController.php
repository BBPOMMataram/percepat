...
class PermintaanReagenController extends Controller
{
    public function index(Request $request)
    {
        ...
        // $kode_or_name = $request->query('kode_or_name', null);

        $query = Permintaan::with(['peminta', 'status', 'bidang', 'bidang.user', 'katim'])->latest();

        // if ($kode_or_name) {
        //     $query->where('kode', 'like', '%' . $kode_or_name . '%')
        //         ->orWhere('nama', 'like', '%' . $kode_or_name . '%');
        // }
