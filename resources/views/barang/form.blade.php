      ...
      <div class="card-body">
        ...
        <form id="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control form-control-rounded" id="expired" name="expired"
              placeholder="Satuan" @isset($editeddata)
              value="{{ $editeddata->expired ? $editeddata->expired->format('Y-m-d') : '' }}" @endisset>
          </div>
          <div class="form-group">
