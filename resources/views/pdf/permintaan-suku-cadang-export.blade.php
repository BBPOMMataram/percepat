...
<body>
    <h2>Daftar Permintaan Suku Cadang</h2>
    <div class="meta">
        ...
        <tbody>
            @forelse($items as $i => $item)
                <tr>
                    ...
                    <td>
                        @if ($item->permintaanListSukuCadang && $item->permintaanListSukuCadang->count())
                            <ul class="barang-list">
                                @foreach ($item->permintaanListSukuCadang as $list)
                                    <li>
                                        {{ $list->sukuCadang?->name ?? '-' }}
